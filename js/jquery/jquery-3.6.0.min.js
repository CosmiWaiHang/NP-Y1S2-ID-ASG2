...
!function (e, t) {
    ...
    var t = [], r = Object.getPrototypeOf, s = t.slice,
            g = t.flat ? function (e) {return t.flat.call(e);} : function (e) {return t.concat.apply([], e);}, u = t.push,
            i = t.indexOf, n = {}, o = n.toString, v = n.hasOwnProperty, a = v.toString, l = a.call(Object), y = {},
    ...
    var d = function (n) {
        var e, d, b, o, i, h, f, g, w, u, l, T, C, a, E, v, s, c, y, S = 'sizzle' + 1 * new Date, p = n.document, k = 0,
                r = 0, m = ue(), x = ue(), A = ue(), N = ue(), j = function (e, t) {return e === t && (l = !0), 0;},
        ...
        try {H.apply(t = O.call(p.childNodes), p.childNodes), t[p.childNodes.length].nodeType;}
        catch (e) {
            H = {
        ...
        function Ee(e) {
            for (var i, t, n, r = e.length, o = b.relative[e[0].type], a = o || b.relative[' '], s = o ? 1 : 0, u = be(function (e) {return e === i;}, a, !0), l = be(function (e) {return -1 < P(i, e);}, a, !0), c = [
                function (e, t, n) {
    ...
    function Z(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType) {
            if (r = 'data-' + t.replace(K, '-$&').toLowerCase(), 'string' == typeof (n = e.getAttribute(r))) {
                try {n = 'true' === (i = n) || 'false' !== i && ('null' === i ? null : i === +i + '' ? +i : J.test(i) ? JSON.parse(i) : i);}
                catch (e) {}
                Q.set(e, t, n);
            }
            else {
    ...
    var ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, te = new RegExp('^(?:([+-])=|)(' + ee + ')([a-z%]*)$', 'i'),
            ...
            ie = function (e) {return S.contains(e.ownerDocument, e);}, oe = {composed: !0};
    ...
    function se(e, t, n, r) {
        var i, o, a = 20, s = r ? function () {return r.cur();} : function () {return S.css(e, t, '');}, u = s(),
    ...
    S.event = {
        ...
        S.event.special[e] = {
            setup: function () {return Se(this, e, Ce), !1;},
            trigger: function () {return Se(this, e), !0;},
        ...
        on: function (e, t, n, r) {return Ee(this, e, t, n, r);},
        one: function (e, t, n, r) {return Ee(this, e, t, n, r, 1);},
        off: function (e, t, n) {
            var r, i;
    ...
    S.extend({
        ...
        S.cssHooks[u] = {
            get: function (e, t, n) {
                if (t) {
                    return !Ue.test(S.css(e, 'display')) || e.getClientRects().length && e.getBoundingClientRect().width ? Je(e, u, n) : Me(e, Ve, function () {return Je(e, u, n);});
                }
            },
            set: function (e, t, n) {
        ...
        if (t) {
            return (parseFloat(We(e, 'marginLeft')) || e.getBoundingClientRect().left - Me(e, {marginLeft: 0}, function () {return e.getBoundingClientRect().left;})) + 'px';
        }
    }), S.each({
        margin: '',
        padding: '',
    ...
    function lt(o, e, t) {
        var n, a, r = 0, i = lt.prefilters.length, s = S.Deferred().always(function () {delete u.elem;}),
                u = function () {
                    if (a) {
                        return !1;
                    }
    ...
    S.fn.extend({
        attr: function (e, t) {return $(this, S.attr, e, t, 1 < arguments.length);},
    ...
    S.fn.extend({
        prop: function (e, t) {return $(this, S.prop, e, t, 1 < arguments.length);},
        ...
        addClass: function (t) {
            ...
            if (m(t)) {
                return this.each(function (e) {S(this).addClass(t.call(this, e, gt(this)));});
            }
            if ((e = vt(t)).length) {
                while (n = this[u++]) {
            ...
            var e, n, r, i, o, a, s, u = 0;
            if (m(t)) {
                return this.each(function (e) {S(this).removeClass(t.call(this, e, gt(this)));});
            }
            if (!arguments.length) {
    ...
    S.extend(S.event, {
        ...
        trigger: function (e, t) {return this.each(function () {S.event.trigger(e, t, this);});},
    ...
    S.parseXML = function (e) {
        ...
        try {t = (new C.DOMParser).parseFromString(e, 'text/xml');}
        catch (e) {}
    ...
    Mt.href = bt.href, S.extend({
        ...
        ajax: function (e, t) {
            ...
            if (x.promise(T), v.url = ((e || v.url || bt.href) + '').replace(Ht, bt.protocol + '//'), v.type = t.method || t.type || v.method || v.type, v.dataTypes = (v.dataType || '*').toLowerCase().match(P) || [''], null == v.crossDomain) {
                r = E.createElement('a');
                try {r.href = v.url, r.href = r.href, v.crossDomain = Mt.protocol + '//' + Mt.host != r.protocol + '//' + r.host;}
    ...
    S.ajaxSetup({
        ...
        offset: function (t) {
            if (arguments.length) {
                return void 0 === t ? this : this.each(function (e) {S.offset.setOffset(this, t, e)});
            }
            var e, n, r = this[0];
